<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="search">RECHERCHE AVANCÉE</a>
            </li>
        ...
        <form class="form-inline my-2 my-lg-0">
            <a class="nav-link btn btn-secondary mr-3" href="signup">INSCRIPTION</a>
            <?php
            if(isset($_SESSION['connecter']) && $_SESSION['connecter'] === true || isset($_SESSION['connecter_user']) && $_SESSION['connecter_user'] === true){
                ?>
                <a class="nav-link btn btn-danger" href="index.php?url=logout">DECONNEXION</a>
                <?php
            }else{
                ?>
                <a class="nav-link btn btn-warning" href="index.php?url=login">CONNEXION</a>
                <?php
            }
            ?>
