...
$gites = new Gites();
$id = $_GET['id'];
$gites->giteToDelete($id);
?>
<div class="main-container mt-3">
    <h1 class="text-info text-center">Mettre à jour le gite</h1>
    <form action="" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <label for="nom_gite">Nom du gite : </label>
            <input type="text" class="form-control" id="nom_gite" name="nom_gite">
        </div>
        ...
        <button type="submit" name="maj_gite_btn" class="btn btn-outline-success">Mettre à jour le gite</button>
    </form>
</div>
